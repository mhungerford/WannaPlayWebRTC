...
## (Update) WannaPlay WebRTC Notice
> Yoke has been modified to be used as a standalone virtual joystick library.  This enables integration into Python applications to enable virtual joysticks and gamepads on Windows/Linux/Mac.
